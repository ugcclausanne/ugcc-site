    ...
    return (
      <div className="container">
        ...
        <div style={{ marginTop: 12 }}>
          ...
          {manualOpen && (
            <div style={{ marginTop: 8 }}>
              <p>Створіть Personal Access Token у GitHub (для публічного репозиторію достатньо public_repo) і вставте його тут. Токен зберігається лише у вашому браузері.</p>
  ...
  return (
    <div className="container">
      ...
      <nav style={{ marginTop: 16, marginBottom: 16 }}>
        ...
        <button className="btn" onClick={() => setTab('schedule')} disabled={tab === 'schedule'} style={{ marginLeft: 8 }}>Розклад</button>
      </nav>
